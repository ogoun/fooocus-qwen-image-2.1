"""Собирает каталог поз openposes.com (модель — Эмма Уотсон) в ``resources/poses/catalog``.

Каталог лежит в репозитории; скрипт нужен, чтобы собрать его заново или
обновить с сайта, в том числе из уже скачанного архива:
